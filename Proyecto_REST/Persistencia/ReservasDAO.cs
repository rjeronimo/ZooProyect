...
namespace Proyecto_REST.Persistencia
{
    public class ReservasDAO
    {
        ...
        {
            Reservas presupuetoRegistrado = null;
           ...
           presupuetoRegistrado = Obtener(reservaARegistrar.CodigoReserva); 
            return presupuetoRegistrado;
        }
                ...
                using (SqlCommand com = new SqlCommand(sql, con))
                {
                     using (SqlDataReader resultado = com.ExecuteReader())
                    {
                        while (resultado.Read())
                        {
                            ...
                            {
                                CodigoReserva = (int)resultado["codreserva"],
                                CodigoUsuario = (int)resultado["codpersona"],
                                Asistentes = (int)resultado["asistentes"],
                                Fecha_reserva = (DateTime)resultado["fecha_Reserva"],
